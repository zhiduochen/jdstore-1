...
products =[{title:"上海国际马拉松赛报名",
          ...
          {title:"北京国际马拉松赛报名",
          	        description: "北京，跑向能量之巅。",
          	        image_path: "#{Rails.root}/app/assets/images/北马.jpg"},

	        {title:"应急医疗技术EMT培训班报名",
...
p1 = Product.create([title:products[0][:title],description:products[0][:description],quantity:20,price:200,image:open(products[0][:image_path])])
p2 = Product.create([title:products[1][:title],description:products[1][:description],quantity:20,price:4000,image:open(products[1][:image_path])])
